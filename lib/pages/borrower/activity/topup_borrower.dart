...
class BorrowerTopUpPage extends StatefulWidget {
  const BorrowerTopUpPage({super.key});

  @override
  State<BorrowerTopUpPage> createState() => _BorrowerTopUpPageState();
}

class _BorrowerTopUpPageState extends State<BorrowerTopUpPage> {
  ...
  // Future<void> topUpSaldo(int user_id, int value) async {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body:
          //     BlocBuilder<UserCubit, UserModel>(buildWhen: (previousState, state) {
